//
// Created by Bojie Shen on 27/5/21.
//

#ifndef KATCH_BSTCH_H
#define KATCH_BSTCH_H
#include <array>
#include <cassert>
#include <cmath>
#include <deque>
...
namespace katch
{
    ...
    public:
        ...
        BSTCH(std::vector<SearchGraph<&period>>&& graph)
...
//            _t_dep = t_dep;
        ...
        Path get_path(NodeIterator node) const noexcept{
            const katch::BSTCH::Path up_down_path = get_up_down_path(node);
