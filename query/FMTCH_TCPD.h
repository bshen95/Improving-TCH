...
#ifndef KATCH_FMTCH_TCPD_H
#define KATCH_FMTCH_TCPD_H
#include <array>
#include <cassert>
#include <cmath>
#include <deque>
...
namespace katch
{
    ...
    private:
        ...
        vector<FMTCH_TCPDQuery_Wrapper*> hourly_query;
...
//                                 <<" Heuristic: "<<v._heuristic<<" Downward ? "<< v._is_downward<< std::endl;
    ...
    public:
        ...
        FMTCH_TCPD(ForwardSearchGraph<&period> && graph)
        ...
        void set_hourly_queries(vector<FMTCH_TCPDQuery_Wrapper*> h_queries){
            hourly_query  = std::move(h_queries);
        }
