...
//
            assert( _nodes[u]._out_edges_begin == INVALID_FW_EDGE_ITERATOR ||
                            (size_t) _nodes[u]._out_edges_begin <= _forward_edges.size() );
            assert( _nodes[u]._out_edges_end == INVALID_FW_EDGE_ITERATOR ||
                    (size_t)_nodes[u]._out_edges_end <= _forward_edges.size() );
            ...
            assert( _nodes[u]._in_edges_begin == INVALID_BW_EDGE_ITERATOR || (size_t)_nodes[u]._in_edges_begin <= _backward_edges.size() );
            assert( _nodes[u]._in_edges_end == INVALID_BW_EDGE_ITERATOR || (size_t)_nodes[u]._in_edges_end <= _backward_edges.size() );
