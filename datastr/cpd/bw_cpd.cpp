...
namespace  katch {
    ...
    void BW_CPD::append_rows(const BW_CPD &other) {
    ...
    void BW_CPD::append_rows(const BW_CPD &other, unsigned row_id) {
    ...
    void BW_CPD::append_compressed_row(const vector<unsigned>& compressed_row){
